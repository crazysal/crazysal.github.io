---
layout: post
title:  "Sequence Generative Adversarial Nets with Policy Gradient : SeqGAN "
date:   2018-04-03 16:16:01 -0600
tags: [nlp chatbot deep-learning seqGan reinforcement-learning]
repository_url : https://github.com/crazysal/chatty/tree/master/DeepQA-master
zip_url : https://github.com/crazysal/chatty/archive/master.zip
tar_url : https://github.com/crazysal/chatty/archive/master.tar.gz
---

### This work tries to reproduce the results of  [SeqGAN: Sequence Generative Adversarial Nets with Policy Gradient](http://arxiv.org/abs/1609.05473) (aka SeqGan). It uses a RNN sequence as a generator and the discriminator  Modeling the data generator as a stochastic policy in reinforcement learning (RL),SeqGAN bypasses the generator differentiation problem by directly performing gradient  policy  update.
...
![seqGan](https://raw.githubusercontent.com/LantaoYu/SeqGAN/master/figures/seqgan.png)
